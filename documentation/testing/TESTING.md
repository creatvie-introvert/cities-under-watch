...
| CAT-02 | Active Products Display | Review the catalogue product grid | All active products are displayed in the catalogue | All active products were displayed correctly in the catalogue grid | All active products were displayed correctly in the catalogue grid | PASS |
...
| CAT-23 | Catalogue Mobile Layout | Open catalogue and collection pages on mobile viewport | Layout is stable, reusable, and visually consitent on mobile | Catalogue and collection pages remained stable and visually consistent on mobile | PASS | |
